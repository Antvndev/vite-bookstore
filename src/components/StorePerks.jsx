    ...
    <section className="w-full py-12 ">
      <div className="max-w-6xl mx-auto px-4 grid grid-cols-1 sm:grid-cols-3 gap-8">
        ...
        <div className="flex flex-col items-center text-center gap-3">
          ...
          <h3 className="text-xl font-bold text-text">Free Shipping</h3>
          <p className="text-text/70 text-m">On all orders above $50</p>
        </div>
        ...
        <div className="flex flex-col items-center text-center gap-3">
          ...
          <h3 className="text-xl font-bold text-text">Secure Payments</h3>
          <p className="text-text/70 text-m">100% secure transactions</p>
        </div>
